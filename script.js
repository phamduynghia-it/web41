document.addEventListener("DOMContentLoaded", () => {
    ...
    const messages = ["Dương Đình Trường ", "Luôn bên anh ❤️", "Mãi yêu ❤️"];
    ...
    const opts = isMobile
        ? {
              ...
              zRange: 650,
              depthScale: { min: 1.5, max: 2.5 },
              durationRange: { base: 5, random: 5 },
              creationIntervalTime: { text: 1000, heart: 3200 },
              delayRange: 2,
